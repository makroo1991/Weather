...
+ (DBManager *)sharedInstance {
    ...
    static dispatch_once_t oneTimeChecker;
    dispatch_once(&oneTimeChecker, ^{
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "Mark.Weather" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"WeatherDB" withExtension:@"momd"];
